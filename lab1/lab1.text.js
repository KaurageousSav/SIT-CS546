...
console.log(lab1.questionOne([2, 3, 10]));
...
console.log(lab1.questionThree(["bar", "car", "car", "arc", "cat", "act"])); 
...
console.log(lab1.questionFour(0, 9, 7));
console.log(lab1.questionFour(4, 6, 8));
console.log(lab1.questionFour(2, 8, 3));
